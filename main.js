...
document.getElementById("result3").innerHTML = sketch;
...
function classifyCanvas() {
    doodle_net.classify(canvas, gotresult);
}
function gotresult(error, results) {
    if(error) {
        ...
        document.getElementById("result1").innerHTML = drawn_sketch;
        document.getElementById("result2").innerHTML = Math.round(results[0].confidence * 100) + "%";
    }
    if(drawn_sketch == sketch) {
        score = score + 1;
        document.getElementById("score_result").innerHTML = score;
